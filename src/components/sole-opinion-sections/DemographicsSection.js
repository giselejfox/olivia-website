    ...
    return (
        <div className="me-4">
            ...
            <label className="form-check-label" htmlFor={gender + "Radio"}>
                ...
                <svg className="me-2" width="68" height="26" viewBox="0 0 68 26" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div className="me-4 d-flex flex-row align-items-center">
            ...
            <label className="form-label" htmlFor="gender">
                <svg value="Not Listed" className="me-2" width="68" height="26" viewBox="0 0 68 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_14_147)">
