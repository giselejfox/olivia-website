...
function TestUpper1({ svgClasses}) {
    return (
        <svg className={svgClasses} viewBox="0 0 480 479" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M287.53 0H191.53V123.619L104.118 36.2077L36.236 104.09L123.719 191.573L0 191.65L0.0602646 287.65L122.361 287.574L35.2849 374.333L103.043 442.339L191.53 354.174V479H287.53V355.381L374.942 442.792L442.824 374.91L355.341 287.427L479.06 287.35L479 191.35L354.87 191.428L442.364 104.252L374.605 36.2459L287.53 123.004V0Z" fill="url(#paint0_linear_4_28)"/>
            <defs>
